...
#frames extrated from ntu and ntu120, should be separate folders named by video names(started by S), and inside the folders are frames of the video.
frame_path = '/ntu_rgb_frames/'
frame_path_120 = '/extract_ntu_frame_outfolder/NTU120/'
#skeleton files extrated by OpenPose.
openpose_path = '/openpose/'
openpose_path_120 = '/openpose_2dskeletons_ntu120/'

save_path = '/ntu_rgb_frames_crop/rgb55/'
save_path_120 = '/rgb55/'
depth_path = 'F:/DATASETS/NTU60/nturgb+d_depth_masked/'
depth_path_120 = 'F:/DATASETS/NTU120/nturgb+d_depth_masked/'
debug = False
...
def construct_st_roi(filename, evaluation=False, random_interval=False,random_roi_move=False,random_flip=False, temporal_rgb_frames=5):
    ...
    if os.path.isdir(frame_file):# and action_id == 50:
        ...
        if action_id < 61:
            frames_save = save_path + skeleton_file_name +'.jpg'
        else:
            frames_save = save_path_120 + skeleton_file_name +'.jpg'
...
if __name__ == '__main__':
    ...
    folder = 'F:/DATASETS/NTU120/nturgb+d_skeletons/'
    ignored_sample_path = 'samples_with_missing_skeletons.txt'

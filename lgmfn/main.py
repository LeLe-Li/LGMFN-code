...
from model_rgb_efficient import Model
...
def init_parse():
    parser = argparse.ArgumentParser(description="anonymous")
    parser.add_argument('--mode', type=str, default='train', help='want to train or val')
    parser.add_argument('--exp_dir', type=str, default='', help='')#ignore it
    parser.add_argument('--output', type=str, default='0701-rgb51-effi', help='')
    ...
    parser.add_argument('--num_workers', type=int, default=20, help='number of workers for train')
    ...
    parser.add_argument('--rgb_images_path', type=str, default='/home/user/rgb51_fullrgb/', help='')
